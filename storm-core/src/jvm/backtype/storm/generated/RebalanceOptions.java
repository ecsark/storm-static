          ...
          if (field.type == org.apache.thrift7.protocol.TType.MAP) {
            {
              ...
              this.num_executors = new HashMap<String,Integer>(2*_map163.size);
              for (int _i164 = 0; _i164 < _map163.size; ++_i164)
              {
                String _key165; // required
                int _val166; // required
                _key165 = iprot.readString();
                _val166 = iprot.readI32();
                this.num_executors.put(_key165, _val166);
              }
              iprot.readMapEnd();
            }
          } else { 
    ...
    if (this.num_executors != null) {
      if (is_set_num_executors()) {
        oprot.writeFieldBegin(NUM_EXECUTORS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Integer> _iter167 : this.num_executors.entrySet())
          {
