      ...
      switch (field.id) {
        case 1: // ACKED
          if (field.type == org.apache.thrift7.protocol.TType.MAP) {
            {
              org.apache.thrift7.protocol.TMap _map50 = iprot.readMapBegin();
              this.acked = new HashMap<String,Map<GlobalStreamId,Long>>(2*_map50.size);
              for (int _i51 = 0; _i51 < _map50.size; ++_i51)
              {
                String _key52; // required
                Map<GlobalStreamId,Long> _val53; // required
                _key52 = iprot.readString();
                {
                  org.apache.thrift7.protocol.TMap _map54 = iprot.readMapBegin();
                  _val53 = new HashMap<GlobalStreamId,Long>(2*_map54.size);
                  for (int _i55 = 0; _i55 < _map54.size; ++_i55)
                  {
                    GlobalStreamId _key56; // required
                    long _val57; // required
                    _key56 = new GlobalStreamId();
                    _key56.read(iprot);
                    _val57 = iprot.readI64();
                    _val53.put(_key56, _val57);
                  }
                  iprot.readMapEnd();
                }
                this.acked.put(_key52, _val53);
              }
              iprot.readMapEnd();
            }
          } else { 
        ...
        case 2: // FAILED
          if (field.type == org.apache.thrift7.protocol.TType.MAP) {
            {
              org.apache.thrift7.protocol.TMap _map58 = iprot.readMapBegin();
              this.failed = new HashMap<String,Map<GlobalStreamId,Long>>(2*_map58.size);
              for (int _i59 = 0; _i59 < _map58.size; ++_i59)
              {
                String _key60; // required
                Map<GlobalStreamId,Long> _val61; // required
                _key60 = iprot.readString();
                {
                  org.apache.thrift7.protocol.TMap _map62 = iprot.readMapBegin();
                  _val61 = new HashMap<GlobalStreamId,Long>(2*_map62.size);
                  for (int _i63 = 0; _i63 < _map62.size; ++_i63)
                  {
                    GlobalStreamId _key64; // required
                    long _val65; // required
        ...
        case 3: // PROCESS_MS_AVG
          if (field.type == org.apache.thrift7.protocol.TType.MAP) {
            {
              org.apache.thrift7.protocol.TMap _map66 = iprot.readMapBegin();
              this.process_ms_avg = new HashMap<String,Map<GlobalStreamId,Double>>(2*_map66.size);
              for (int _i67 = 0; _i67 < _map66.size; ++_i67)
              {
                String _key68; // required
                Map<GlobalStreamId,Double> _val69; // required
                _key68 = iprot.readString();
                {
                  org.apache.thrift7.protocol.TMap _map70 = iprot.readMapBegin();
                  _val69 = new HashMap<GlobalStreamId,Double>(2*_map70.size);
                  for (int _i71 = 0; _i71 < _map70.size; ++_i71)
                  {
                    GlobalStreamId _key72; // required
                    double _val73; // required
                ...
                this.process_ms_avg.put(_key68, _val69);
              }
              iprot.readMapEnd();
            }
          } else { 
        ...
        case 4: // EXECUTED
          if (field.type == org.apache.thrift7.protocol.TType.MAP) {
            {
              org.apache.thrift7.protocol.TMap _map74 = iprot.readMapBegin();
              this.executed = new HashMap<String,Map<GlobalStreamId,Long>>(2*_map74.size);
              for (int _i75 = 0; _i75 < _map74.size; ++_i75)
              {
                String _key76; // required
                Map<GlobalStreamId,Long> _val77; // required
                _key76 = iprot.readString();
                {
                  org.apache.thrift7.protocol.TMap _map78 = iprot.readMapBegin();
                  _val77 = new HashMap<GlobalStreamId,Long>(2*_map78.size);
                  for (int _i79 = 0; _i79 < _map78.size; ++_i79)
                  {
                    GlobalStreamId _key80; // required
                ...
                this.executed.put(_key76, _val77);
              }
              iprot.readMapEnd();
            }
          } else { 
        ...
        case 5: // EXECUTE_MS_AVG
          if (field.type == org.apache.thrift7.protocol.TType.MAP) {
            {
              org.apache.thrift7.protocol.TMap _map82 = iprot.readMapBegin();
              this.execute_ms_avg = new HashMap<String,Map<GlobalStreamId,Double>>(2*_map82.size);
              for (int _i83 = 0; _i83 < _map82.size; ++_i83)
              {
                String _key84; // required
                Map<GlobalStreamId,Double> _val85; // required
                _key84 = iprot.readString();
                {
                  org.apache.thrift7.protocol.TMap _map86 = iprot.readMapBegin();
                  _val85 = new HashMap<GlobalStreamId,Double>(2*_map86.size);
                  for (int _i87 = 0; _i87 < _map86.size; ++_i87)
                  {
                    GlobalStreamId _key88; // required
                    double _val89; // required
                    _key88 = new GlobalStreamId();
                    _key88.read(iprot);
                    _val89 = iprot.readDouble();
                    _val85.put(_key88, _val89);
                  }
                  iprot.readMapEnd();
                }
                this.execute_ms_avg.put(_key84, _val85);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(org.apache.thrift7.protocol.TProtocol oprot) throws org.apache.thrift7.TException {
    ...
    if (this.acked != null) {
      oprot.writeFieldBegin(ACKED_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, Map<GlobalStreamId,Long>> _iter90 : this.acked.entrySet())
        {
          oprot.writeString(_iter90.getKey());
          {
            oprot.writeMapBegin(new org.apache.thrift7.protocol.TMap(org.apache.thrift7.protocol.TType.STRUCT, org.apache.thrift7.protocol.TType.I64, _iter90.getValue().size()));
            for (Map.Entry<GlobalStreamId, Long> _iter91 : _iter90.getValue().entrySet())
            {
    ...
    if (this.failed != null) {
      oprot.writeFieldBegin(FAILED_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, Map<GlobalStreamId,Long>> _iter92 : this.failed.entrySet())
        {
          oprot.writeString(_iter92.getKey());
          {
            oprot.writeMapBegin(new org.apache.thrift7.protocol.TMap(org.apache.thrift7.protocol.TType.STRUCT, org.apache.thrift7.protocol.TType.I64, _iter92.getValue().size()));
            for (Map.Entry<GlobalStreamId, Long> _iter93 : _iter92.getValue().entrySet())
            {
              _iter93.getKey().write(oprot);
    ...
    if (this.process_ms_avg != null) {
      oprot.writeFieldBegin(PROCESS_MS_AVG_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, Map<GlobalStreamId,Double>> _iter94 : this.process_ms_avg.entrySet())
        {
          oprot.writeString(_iter94.getKey());
          {
            oprot.writeMapBegin(new org.apache.thrift7.protocol.TMap(org.apache.thrift7.protocol.TType.STRUCT, org.apache.thrift7.protocol.TType.DOUBLE, _iter94.getValue().size()));
            for (Map.Entry<GlobalStreamId, Double> _iter95 : _iter94.getValue().entrySet())
            {
    ...
    if (this.executed != null) {
      oprot.writeFieldBegin(EXECUTED_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, Map<GlobalStreamId,Long>> _iter96 : this.executed.entrySet())
        {
          oprot.writeString(_iter96.getKey());
          {
            oprot.writeMapBegin(new org.apache.thrift7.protocol.TMap(org.apache.thrift7.protocol.TType.STRUCT, org.apache.thrift7.protocol.TType.I64, _iter96.getValue().size()));
            for (Map.Entry<GlobalStreamId, Long> _iter97 : _iter96.getValue().entrySet())
            {
              _iter97.getKey().write(oprot);
    ...
    if (this.execute_ms_avg != null) {
      oprot.writeFieldBegin(EXECUTE_MS_AVG_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, Map<GlobalStreamId,Double>> _iter98 : this.execute_ms_avg.entrySet())
        {
          oprot.writeString(_iter98.getKey());
          {
            oprot.writeMapBegin(new org.apache.thrift7.protocol.TMap(org.apache.thrift7.protocol.TType.STRUCT, org.apache.thrift7.protocol.TType.DOUBLE, _iter98.getValue().size()));
            for (Map.Entry<GlobalStreamId, Double> _iter99 : _iter98.getValue().entrySet())
            {
              _iter99.getKey().write(oprot);
