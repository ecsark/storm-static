          ...
          if (field.type == org.apache.thrift7.protocol.TType.MAP) {
            {
              ...
              for (int _i117 = 0; _i117 < _map116.size; ++_i117)
              {
                ...
                {
                  org.apache.thrift7.protocol.TMap _map120 = iprot.readMapBegin();
  ...
  public void write(org.apache.thrift7.protocol.TProtocol oprot) throws org.apache.thrift7.TException {
    ...
    if (this.acked != null) {
      oprot.writeFieldBegin(ACKED_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, Map<String,Long>> _iter124 : this.acked.entrySet())
        {
          oprot.writeString(_iter124.getKey());
          {
            oprot.writeMapBegin(new org.apache.thrift7.protocol.TMap(org.apache.thrift7.protocol.TType.STRING, org.apache.thrift7.protocol.TType.I64, _iter124.getValue().size()));
            for (Map.Entry<String, Long> _iter125 : _iter124.getValue().entrySet())
            {
              oprot.writeString(_iter125.getKey());
              oprot.writeI64(_iter125.getValue());
            }
            oprot.writeMapEnd();
          }
        }
    ...
    if (this.failed != null) {
      oprot.writeFieldBegin(FAILED_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, Map<String,Long>> _iter126 : this.failed.entrySet())
        {
          oprot.writeString(_iter126.getKey());
          {
            oprot.writeMapBegin(new org.apache.thrift7.protocol.TMap(org.apache.thrift7.protocol.TType.STRING, org.apache.thrift7.protocol.TType.I64, _iter126.getValue().size()));
            for (Map.Entry<String, Long> _iter127 : _iter126.getValue().entrySet())
            {
    ...
    if (this.complete_ms_avg != null) {
      oprot.writeFieldBegin(COMPLETE_MS_AVG_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, Map<String,Double>> _iter128 : this.complete_ms_avg.entrySet())
        {
          oprot.writeString(_iter128.getKey());
          {
            oprot.writeMapBegin(new org.apache.thrift7.protocol.TMap(org.apache.thrift7.protocol.TType.STRING, org.apache.thrift7.protocol.TType.DOUBLE, _iter128.getValue().size()));
            for (Map.Entry<String, Double> _iter129 : _iter128.getValue().entrySet())
            {
