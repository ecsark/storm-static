...
public class TopologyInfo implements org.apache.thrift7.TBase<TopologyInfo, TopologyInfo._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    ...
    tmpMap.put(_Fields.EXECUTORS, new org.apache.thrift7.meta_data.FieldMetaData("executors", org.apache.thrift7.TFieldRequirementType.REQUIRED, 
      ...
      switch (field.id) {
        ...
        case 4: // EXECUTORS
          if (field.type == org.apache.thrift7.protocol.TType.LIST) {
            {
              org.apache.thrift7.protocol.TList _list150 = iprot.readListBegin();
              this.executors = new ArrayList<ExecutorSummary>(_list150.size);
              for (int _i151 = 0; _i151 < _list150.size; ++_i151)
              {
                ExecutorSummary _elem152; // required
                _elem152 = new ExecutorSummary();
                _elem152.read(iprot);
                this.executors.add(_elem152);
              }
              iprot.readListEnd();
            }
          } else { 
          ...
          if (field.type == org.apache.thrift7.protocol.TType.MAP) {
            {
              ...
              this.errors = new HashMap<String,List<ErrorInfo>>(2*_map153.size);
              for (int _i154 = 0; _i154 < _map153.size; ++_i154)
              {
                String _key155; // required
                List<ErrorInfo> _val156; // required
                _key155 = iprot.readString();
                {
                  org.apache.thrift7.protocol.TList _list157 = iprot.readListBegin();
                  _val156 = new ArrayList<ErrorInfo>(_list157.size);
                  for (int _i158 = 0; _i158 < _list157.size; ++_i158)
                  {
                    ErrorInfo _elem159; // required
                    _elem159 = new ErrorInfo();
                    _elem159.read(iprot);
                    _val156.add(_elem159);
                  }
                  iprot.readListEnd();
                }
                this.errors.put(_key155, _val156);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(org.apache.thrift7.protocol.TProtocol oprot) throws org.apache.thrift7.TException {
    ...
    if (this.executors != null) {
      oprot.writeFieldBegin(EXECUTORS_FIELD_DESC);
      {
        ...
        for (ExecutorSummary _iter160 : this.executors)
        {
    ...
    if (this.errors != null) {
      oprot.writeFieldBegin(ERRORS_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, List<ErrorInfo>> _iter161 : this.errors.entrySet())
        {
          oprot.writeString(_iter161.getKey());
          {
            oprot.writeListBegin(new org.apache.thrift7.protocol.TList(org.apache.thrift7.protocol.TType.STRUCT, _iter161.getValue().size()));
            for (ErrorInfo _iter162 : _iter161.getValue())
            {
  ...
  public void validate() throws org.apache.thrift7.TException {
    ...
    if (!is_set_executors()) {
      throw new org.apache.thrift7.protocol.TProtocolException("Required field 'executors' is unset! Struct:" + toString());
    }
