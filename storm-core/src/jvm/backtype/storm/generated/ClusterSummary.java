      ...
      switch (field.id) {
        case 1: // SUPERVISORS
          if (field.type == org.apache.thrift7.protocol.TType.LIST) {
            {
              org.apache.thrift7.protocol.TList _list42 = iprot.readListBegin();
              this.supervisors = new ArrayList<SupervisorSummary>(_list42.size);
              for (int _i43 = 0; _i43 < _list42.size; ++_i43)
              {
                SupervisorSummary _elem44; // required
                _elem44 = new SupervisorSummary();
                _elem44.read(iprot);
                this.supervisors.add(_elem44);
              }
              iprot.readListEnd();
            }
          } else { 
          ...
          if (field.type == org.apache.thrift7.protocol.TType.LIST) {
            {
              ...
              this.topologies = new ArrayList<TopologySummary>(_list45.size);
              for (int _i46 = 0; _i46 < _list45.size; ++_i46)
              {
                TopologySummary _elem47; // required
                _elem47 = new TopologySummary();
                _elem47.read(iprot);
                this.topologies.add(_elem47);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(org.apache.thrift7.protocol.TProtocol oprot) throws org.apache.thrift7.TException {
    ...
    if (this.supervisors != null) {
      oprot.writeFieldBegin(SUPERVISORS_FIELD_DESC);
      {
        ...
        for (SupervisorSummary _iter48 : this.supervisors)
        {
          _iter48.write(oprot);
        }
        oprot.writeListEnd();
    ...
    if (this.topologies != null) {
      oprot.writeFieldBegin(TOPOLOGIES_FIELD_DESC);
      {
        ...
        for (TopologySummary _iter49 : this.topologies)
        {
          _iter49.write(oprot);
        }
        oprot.writeListEnd();
