...
public class StormTopology implements org.apache.thrift7.TBase<StormTopology, StormTopology._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final org.apache.thrift7.protocol.TField STATE_BOLTS_FIELD_DESC = new org.apache.thrift7.protocol.TField("state_bolts", org.apache.thrift7.protocol.TType.MAP, (short)3);
  private static final org.apache.thrift7.protocol.TField STATE_SPOUTS_FIELD_DESC = new org.apache.thrift7.protocol.TField("state_spouts", org.apache.thrift7.protocol.TType.MAP, (short)4);

  private Map<String,SpoutSpec> spouts; // required
  private Map<String,Bolt> bolts; // required
  private Map<String,Bolt> state_bolts; // required
  ...
  public enum _Fields implements org.apache.thrift7.TFieldIdEnum {
    ...
    BOLTS((short)2, "bolts"),
    STATE_BOLTS((short)3, "state_bolts"),
  ...
  static {
    ...
    tmpMap.put(_Fields.STATE_BOLTS, new org.apache.thrift7.meta_data.FieldMetaData("state_bolts", org.apache.thrift7.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift7.meta_data.MapMetaData(org.apache.thrift7.protocol.TType.MAP, 
            new org.apache.thrift7.meta_data.FieldValueMetaData(org.apache.thrift7.protocol.TType.STRING), 
            new org.apache.thrift7.meta_data.StructMetaData(org.apache.thrift7.protocol.TType.STRUCT, Bolt.class))));
  ...
  public StormTopology(
    ...
    Map<String,Bolt> state_bolts,
    Map<String,StateSpoutSpec> state_spouts)
  {
    this();
    this.spouts = spouts;
    this.bolts = bolts;
    this.state_bolts = state_bolts;
  ...
  public StormTopology(StormTopology other) {
    ...
    if (other.is_set_state_bolts()) {
      Map<String,Bolt> __this__state_bolts = new HashMap<String,Bolt>();
      for (Map.Entry<String, Bolt> other_element : other.state_bolts.entrySet()) {

        String other_element_key = other_element.getKey();
        Bolt other_element_value = other_element.getValue();

        String __this__state_bolts_copy_key = other_element_key;

        Bolt __this__state_bolts_copy_value = new Bolt(other_element_value);

        __this__state_bolts.put(__this__state_bolts_copy_key, __this__state_bolts_copy_value);
      }
      this.state_bolts = __this__state_bolts;
    }
  ...
  public int get_state_bolts_size() {
    return (this.state_bolts == null) ? 0 : this.state_bolts.size();
  }

  public void put_to_state_bolts(String key, Bolt val) {
    if (this.state_bolts == null) {
      this.state_bolts = new HashMap<String,Bolt>();
    }
    this.state_bolts.put(key, val);
  }

  public Map<String,Bolt> get_state_bolts() {
    return this.state_bolts;
  }

  public void set_state_bolts(Map<String,Bolt> state_bolts) {
    this.state_bolts = state_bolts;
  }

  public void unset_state_bolts() {
    this.state_bolts = null;
  }

  /** Returns true if field state_bolts is set (has been assigned a value) and false otherwise */
  public boolean is_set_state_bolts() {
    return this.state_bolts != null;
  }

  public void set_state_bolts_isSet(boolean value) {
    if (!value) {
      this.state_bolts = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case STATE_BOLTS:
      if (value == null) {
        ...
        set_state_bolts((Map<String,Bolt>)value);
      }
      break;
  ...
  public boolean equals(StormTopology that) {
    ...
    boolean this_present_state_bolts = true && this.is_set_state_bolts();
    boolean that_present_state_bolts = true && that.is_set_state_bolts();
    if (this_present_state_bolts || that_present_state_bolts) {
      if (!(this_present_state_bolts && that_present_state_bolts))
        return false;
      if (!this.state_bolts.equals(that.state_bolts))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_state_bolts = true && (is_set_state_bolts());
    builder.append(present_state_bolts);
    if (present_state_bolts)
      builder.append(state_bolts);
  ...
  public int compareTo(StormTopology other) {
    ...
    lastComparison = Boolean.valueOf(is_set_state_bolts()).compareTo(typedOther.is_set_state_bolts());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_state_bolts()) {
      lastComparison = org.apache.thrift7.TBaseHelper.compareTo(this.state_bolts, typedOther.state_bolts);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
          ...
          if (field.type == org.apache.thrift7.protocol.TType.MAP) {
            {
              ...
              this.state_bolts = new HashMap<String,Bolt>(2*_map30.size);
              for (int _i31 = 0; _i31 < _map30.size; ++_i31)
              {
                ...
                _val33 = new Bolt();
                _val33.read(iprot);
                this.state_bolts.put(_key32, _val33);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(org.apache.thrift7.protocol.TProtocol oprot) throws org.apache.thrift7.TException {
    ...
    if (this.spouts != null) {
      oprot.writeFieldBegin(SPOUTS_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, SpoutSpec> _iter38 : this.spouts.entrySet())
        {
    ...
    if (this.bolts != null) {
      oprot.writeFieldBegin(BOLTS_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, Bolt> _iter39 : this.bolts.entrySet())
        {
    ...
    if (this.state_bolts != null) {
      oprot.writeFieldBegin(STATE_BOLTS_FIELD_DESC);
      {
        oprot.writeMapBegin(new org.apache.thrift7.protocol.TMap(org.apache.thrift7.protocol.TType.STRING, org.apache.thrift7.protocol.TType.STRUCT, this.state_bolts.size()));
        for (Map.Entry<String, Bolt> _iter40 : this.state_bolts.entrySet())
        {
    ...
    if (this.state_spouts != null) {
      oprot.writeFieldBegin(STATE_SPOUTS_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, StateSpoutSpec> _iter41 : this.state_spouts.entrySet())
        {
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("state_bolts:");
    if (this.state_bolts == null) {
      sb.append("null");
    } else {
      sb.append(this.state_bolts);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  public void validate() throws org.apache.thrift7.TException {
    ...
    if (!is_set_state_bolts()) {
      throw new org.apache.thrift7.protocol.TProtocolException("Required field 'state_bolts' is unset! Struct:" + toString());
    }
