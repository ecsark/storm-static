          ...
          if (field.type == org.apache.thrift7.protocol.TType.MAP) {
            {
              ...
              this.emitted = new HashMap<String,Map<String,Long>>(2*_map130.size);
              for (int _i131 = 0; _i131 < _map130.size; ++_i131)
              {
                ...
                this.emitted.put(_key132, _val133);
              }
              iprot.readMapEnd();
            }
          } else { 
          ...
          if (field.type == org.apache.thrift7.protocol.TType.MAP) {
            {
              ...
              this.transferred = new HashMap<String,Map<String,Long>>(2*_map138.size);
              for (int _i139 = 0; _i139 < _map138.size; ++_i139)
              {
                ...
                this.transferred.put(_key140, _val141);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(org.apache.thrift7.protocol.TProtocol oprot) throws org.apache.thrift7.TException {
    ...
    if (this.emitted != null) {
      oprot.writeFieldBegin(EMITTED_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, Map<String,Long>> _iter146 : this.emitted.entrySet())
        {
          oprot.writeString(_iter146.getKey());
          {
            oprot.writeMapBegin(new org.apache.thrift7.protocol.TMap(org.apache.thrift7.protocol.TType.STRING, org.apache.thrift7.protocol.TType.I64, _iter146.getValue().size()));
            for (Map.Entry<String, Long> _iter147 : _iter146.getValue().entrySet())
            {
    ...
    if (this.transferred != null) {
      oprot.writeFieldBegin(TRANSFERRED_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, Map<String,Long>> _iter148 : this.transferred.entrySet())
        {
          oprot.writeString(_iter148.getKey());
          {
            oprot.writeMapBegin(new org.apache.thrift7.protocol.TMap(org.apache.thrift7.protocol.TType.STRING, org.apache.thrift7.protocol.TType.I64, _iter148.getValue().size()));
            for (Map.Entry<String, Long> _iter149 : _iter148.getValue().entrySet())
            {
